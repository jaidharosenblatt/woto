...
import { Select, Form, Input, Button, Col, Row, InputNumber } from "antd";
...
class AddCourseForm extends React.Component {
  ...
  render(){
    ...
    if (this.state.role === "student" || this.state.role === 'teaching assistant'){
        headerMessage = (
          <h2 className="header">
            <b style={{ fontStyle: "bold", color: "#40a9ff" }}>
        ...
        form = (
          <div>
            ...
            <Row>
              <Col xs={24}>
              <Form.Item label= "Course Code" name="course code" rules = {[{required: true}]}>
    ...
    if (this.state.role === "teacher"){
      ...
      form = (
        ...
        <Form.Item label = "Institution" name="institution" rules = {[{required: true}]}>
          ...
          <Form.Item label= "Course Title" name="course title" rules = {[{required: true}]}>
          ...
          <Row>
            ...
            <Col xs = {11} offset = {1}>
              <Form.Item label= "Section Code" name="section code" rules = {[{required: true}]}>
                <Input placeholder="3" />
              </Form.Item>
            </Col>
          </Row>
