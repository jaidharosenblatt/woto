    ...
    return (
      <Card title="Add Session" style={styles.card}>
        ...
        >
          ...
          <Form.Item label="Day of Week" name='dayOfWeek' rules={[{required: true, message: 'Please select day of week!'}]}>
            <Select>
          ...
          <Form.Item name="weekly-repeat" label="Weekly Repeat" required="true" {...dayConfig}>
        ...
        <br/>
          <Row justify="center">
            <Col flex="auto" span={24}>
              <ScheduleTable tableData={this.state.dataSourceStudent} removeUser={this.handleDelete} title="Schedule" />
            </Col>
          </Row>
          <br/>
          <Row>
