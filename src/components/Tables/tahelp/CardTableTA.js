...
import { Card, Row, Col, Table, Switch, Button } from "antd";
...
//function to clear Queue
  ...
  render() {
      if(this.state.title === "Help Students"){
        return (<div className="tahelp-table-component">{this.renderContentEnabled()}</div>);
      } else {
          return ( <div className="tahelp-table-component">{this.renderContentDisabled()}</div>);
      }
