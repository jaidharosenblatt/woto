...
export const AssignmentIcon = require("./assignment.svg");
export const PageIcon = require("./pageicon.svg");
export const ListIcon = require("./listicon.svg");
export const HelpIcon = require("./helpicon.svg");
...
export const BlueQuestionMark = require("./bluequestionmark.svg");
export const GrayQuestionMark = require("./grayquestionmark.svg");
export const BluePencil = require("./bluepencil.svg");
export const GrayClipboard = require("./grayclipboard.svg");
export const GrayPage = require("./graypage.svg");
export const GrayLines = require("./graylines.svg");
